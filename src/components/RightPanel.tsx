...
function OverviewTab({ design }: { design: NormalizedDesign }) {
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <ol className="space-y-2.5">
          {design.architecture.flow.map((step, i) => (
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          {design.architecture.components.map((c, i) => (
...
function StackTab({ design }: { design: NormalizedDesign }) {
  return (
    <div className="space-y-2">
      {design.techStack.map((item, i) => (
        <div
          key={i}
          className="group flex items-start gap-3 rounded-xl border border-gray-100 bg-white p-4 transition-all hover:border-blue-100 hover:shadow-sm"
        >
...
function APIsTab({ design }: { design: NormalizedDesign }) {
  return (
    <div className="space-y-2">
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <div className="space-y-2">
          {design.architecture.decisions.map((d, i) => (
            <div key={i} className="flex gap-3 rounded-xl bg-emerald-50 px-4 py-3.5">
      ...
      <div>
        ...
        <div className="space-y-2">
          {design.architecture.risks.map((r, i) => (
            <div key={i} className="flex gap-3 rounded-xl bg-amber-50 px-4 py-3.5">
